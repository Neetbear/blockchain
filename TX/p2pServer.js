...
const handleTransactionPoolResponse = (recieveTransacionPool) => {
    recieveTransacionPool = JSON.parse(recieveTransacionPool)
...
export { initP2PServer, connectionToPeer, getPeers, mineBlock, broadcasting, autoMineBlock, broadcastingTransactionPool }